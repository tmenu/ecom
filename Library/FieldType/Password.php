...
/**
 * Fichier : /Library/FieldType/Password.php
 * Description : Champs de type password
 * Auteur : Thomas Menu
 * Date : 13/02/2014
 */
...
class Password extends FieldType
{
    public function generateField($label_width = 4)
    {
        ...
        $widget .= '<input type="password" class="form-control" id="' . $this->name . '" name="' . $this->name . '" placeholder="' . $this->label . '"';
