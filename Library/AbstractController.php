...
class AbstractController
{
	...
	public function __construct(Application $application)
	{
		...
		$layout = dirname(__DIR__) . '/Application/' . $this->app['route']['application'] . '/Views/layout.php';
	...
	public function fetch($view = '')
	{
		...
		if ($view === '') {
			...
			$view = dirname(__DIR__) . '/Application/' . $this->app['route']['application'] . '/Views/' . $this->app['route']['controller'] . '/' . $this->app['route']['action'] . '.php';
		}
